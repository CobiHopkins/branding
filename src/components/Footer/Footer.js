...
const Footer = () => {
    ...
    return (
        <Stack direction="row" component="footer" justifyContent="center" alignItems="center" spacing={1} padding={10}>
            ...
            <Link href="https://twitch.tv/CeeJaeRL" rel="noopener noreferrer" target="_blank" underline="none" color="secondary" variant="xlarge"><FaTwitch /></Link>
            <Box sx={{ width: "75px", backgroundColor: "primary.dark", height: "1px", margin: 0, padding: 0, verticalAlign: 'center'}}></Box>
            <Link href="https://x.com/CeeJaeRL" rel="noopener noreferrer" target="_blank" underline="none" color="secondary" variant="xlarge"><FaTwitter /></Link>
